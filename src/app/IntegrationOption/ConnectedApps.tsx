...
export default function ConnectedApps() {
  ...
  return (
     <div className="min-h-screen bg-gray-200 px-4 md:px-12 py-4 max-sm:-mt-8 max-md:-mt-16 md:-mt-16">
      <div className="max-w-5xl mx-auto bg-white rounded-xl shadow p-6 md:p-10">
